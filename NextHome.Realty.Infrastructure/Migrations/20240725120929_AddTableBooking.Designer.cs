...
namespace NextHome.Realty.Persistence.Migrations
{
    ...
    [Migration("20240725120929_AddTableBooking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NextHome.Realty.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("NextHome.Realty.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("NextHome.Realty.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NextHome.Realty.Domain.Entities.Booking", b =>
                {
                    b.HasOne("NextHome.Realty.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
